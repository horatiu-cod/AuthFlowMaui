...
public interface IKeycloakTokenService
{
    ...
    Task<Result<KeycloakTokenResponseDto>> GetClientTokenResponseAsync(string clientId, string clientSecret, string realm, HttpClient httpClient, CancellationToken cancellationToken);
